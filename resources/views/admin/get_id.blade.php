...
<div class="row">
  ...
  <div class="form-group">
   ...
   <input type="email" value="{{$data->email}}"   name="up_email" class="form-control{{ $errors->has('up_email') ? ' is-invalid' : '' }}">
...
<div class="row">
 ...
 <div class="cal-icon">
   <input type="text"  value="{{$data->birthdate}}"  name="b_day" class="form-control{{ $errors->has('b_day') ? ' is-invalid' : '' }} datetimepickerjulz">
   @if ($errors->has('b_day'))
       <div class="invalid-feedback text-danger">
...
<div class="col-lg-6">
 ...
 <div class="cal-icon">
   <input type="text"  value="{{$data->employment_date}}"  name="employment" class="form-control{{ $errors->has('employment') ? ' is-invalid' : '' }} datetimepicker employment}" id="datetimepicker">
...
<div class="row">
  ...
  <div class="form-group">
    ...
    <input type="text"  value="{{$data->team_leader}}"   name="team_leader" class="form-control{{ $errors->has('team_leader') ? ' is-invalid' : '' }}">
...
<div align="left" class="col-sm-12">
  ...
  &nbsp;
<a href="{{url('get_employees')}}" class="btn btn-secondary">Close</a>
</div>
</div>
</form>
