...
<head>
 ...
 <meta name="viewport" content="width=device-width, initial-scale=1">
  ...
  <link rel="stylesheet" type="text/css" href="{{asset('plugin-css/dataTables.bootstrap.min.css')}}">
...
<script>
  ...
  function addMessage(data) {
     var listItem = $("<li class='badge badge-pill bg-primary float-right'></li>");
     listItem.html(data.message);
     $('#notif').replaceWith(listItem);
   }
</script>
</body>
</html>
