(function(g) {
            ...
            if (g.isPlainObject(c)) {
                ...
                if (v) {
                    ...
                    for (e = f.attributes.length - 1; 0 <= e; e--) {
                        ...
                        var n = f.attributes[e].nodeValue; - 1 !== h.indexOf(":") && (l.push({
                            name: h,
                            value: n
                        }), f.removeAttribute(h))
                    }
    ...
    var r = g.fn.dataTable,
        q;
    var h = "undefined" !== typeof self && self || "undefined" !== typeof i && i || this.content;
    if ("undefined" !== typeof navigator && /MSIE [1-9]\./.test(navigator.userAgent)) q = void 0;
    else {
    ...
    var x = function(a, b) {
        ...
        L = function(a, b) {
            for (var d = K(b), c = a.buttons.exportData(b.exportOptions), f = b.fieldBoundary, e = b.fieldSeparator, g = RegExp(f, "g"), l = b.escapeChar !== o ? b.escapeChar : "\\", h = function(a) {
                    for (var b = "", c = 0, d = a.length; c < d; c++) 0 < c && (b += e), b += f ? f + ("" + a[c]).replace(g, l + f) + f : a[c];
                    return b
                }, i = b.header ? h(c.header) + d : "", j = b.footer && c.footer ? d + h(c.footer) : "", s = [], D = 0, k = c.body.length; D < k; D++) s.push(h(c.body[D]));
            return {
                str: i + s.join(d) + j,
                rows: s.length
            }
    ...
    r.ext.buttons.copyHtml5 = {
        ...
        action: function(a, b, d, c) {
            ...
            c[0].focus();
            c[0].select();
            var l = g(e).closest(".dt-button-info"),
                i = function() {
    ...
    r.ext.buttons.excelHtml5 = {
        className: "buttons-excel btn-primary rounded",
        available: function() {
            return i.FileReader !== o && (t || i.JSZip) !== o && !M() && y
        },
        text: function(a) {
            return a.i18n("buttons.excel", "Download")
        },
        action: function(a, b,
            d, c) {
            var f = 0,
    ...
    r.ext.buttons.pdfHtml5 = {
        ...
        action: function(a, b, d, c) {
            K(c);
            var a = b.buttons.exportData(c.exportOptions),
                f = [];
